...
const ViewTC = () => {
  ...
  const handleSave = async (testCaseId) => {
    if (!editedTestCases[testCaseId].input.cpp.trim() || !editedTestCases[testCaseId].input.python.trim() || !editedTestCases[testCaseId].expected_output.trim()) {
    ...
    try {
      ...
      const response = await fetch(`http://localhost:5000/test_cases/${testCaseId}`, {
        method: "PUT",
...
const handleCreateTest = async () => {
    if (!newTestCase.input.cpp.trim() || !newTestCase.input.python.trim() || !newTestCase.expected_output.trim()) {
        showErrorMessage("Visi laukai turi būti užpildyti");
        return;
    }
    try {
          ...
          <div className="testcase-item new-testcase">
            <div className="testcase-header">
              ...
              <div className="testcase-actions">
                ...
                <Button extra="small secondary" onClick={() => setIsCreatingNewTest(false)}>
                  Atšaukti
                </Button>
              </div>
            </div>
            ...
            <div className="testcase-content">
              <div className="input-section">
                <div className="rules-list">
                  <p>Ispėjimas: jūs kuriate testą <a href={`/view_problem/${id}`}>užduočiai su ID {id}:</a></p>
                  <div className="problem-description">
                    <p>{problemDescription}</p>
                  </div> 
                  <p><strong>Esate pilnai atsakingas už visas potencines klaidas</strong>, kurios įvyks jeigu nesilaikysite taisyklių:</p>
                  <li>Kodo sintaksė privalo <strong>būti teisinga.</strong> Nepamirškite kabliataškių (C++ atveju), patikrinkite operatorių teisingumą.</li>
                  <li>Kintamųjų duomenų tipai privalo <strong>atitikti užduotį.</strong> </li>
                  <li>Kintamųjų skaičius privalo <strong>būti lygus</strong> tarp C++ ir Python kalbų.</li>
                  <li>Norimo rezultato reikšmė privalo <strong>laikytis užduotyje nustatytų gairių.</strong> Pavyzdžiui, jeigu užduotis prašo pateikti du skaičius po kablelio, norimas rezultatas taip pat pateiks du skaičius po kablelio ir t.t.</li>
                  <li className="list-warning">Prieš išsaugojant testą, <strong>dar kartą patikrinkite visus testo laukus.</strong></li>
                </div>
                <h4>C++ įvestis:</h4>
                <textarea 
                  required
                  ...
                  onChange={(e) => handleNewTestInputChange('cpp', e.target.value)}
                />
                ...
                <textarea 
                  ...
                  onChange={(e) => handleNewTestInputChange('python', e.target.value)}
                />
              ...
              <div key={tc.id} className="testcase-item">
                <div className="testcase-header">
                  ...
                  {isEditMode[tc.id] ? (
                    <div className="testcase-actions">
                      ...
                      <Button extra="small secondary" onClick={() => handleCancel(tc.id)}>
                        Atšaukti
                      </Button>
                    </div>
                  ) : (
                    <div className="testcase-actions">
                      ...
                      <Button extra="small secondary" onClick={() => handleDelete(tc.id)}>
                        Ištrinti
                      </Button>
                    </div>
                  )}
                ...
                <div className="testcase-content">
                  {isEditMode[tc.id] ? (  
                    <>
                  <div className="rules-list">
                    <p>Ispėjimas: jūs redaguojate testą <a href={`/view_problem/${id}`}>užduočiai su ID {id}:</a></p>
                    <div className="problem-description">
                      <p>{problemDescription}</p>
                    </div> 
                    <p><strong>Esate pilnai atsakingas už visas potencines klaidas</strong>, kurios įvyks jeigu nesilaikysite taisyklių:</p>
                    ...
                    <li className="list-warning">Prieš išsaugojant testą, <strong>dar kartą patikrinkite visus testo laukus.</strong></li>
                      ...
                      <div className="input-section">
                        ...
                        <textarea 
                          ...
                          onChange={(e) => handleInputChange(tc.id, 'cpp', e.target.value)}
                        />
                        ...
                        <textarea 
                          ...
                          onChange={(e) => handleInputChange(tc.id, 'python', e.target.value)}
                        />
                        ...
                        <textarea 
                          ...
                          onChange={(e) => handleOutputChange(tc.id, e.target.value)}
                        />
                      </div>
                    </>
                  ) : (
