...
router.post('/solution', async (req, res) => {
    ...
    if (decToken.user.premium === 0) {
        return res.status(403).json({ message: 'Paslauga skirta tik premium vartotojams' });
    }
...
// )
    ...
    return res.status(200).json({ message: 'Sprendimas gautas', solution: aiSolution });
});
